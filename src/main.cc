...
int main () {
  ...
  try{
    ...
    ///////////////////////////////////////////
    // Initialize a ReadParticles object with the Start_directory and attaching
    ...
    if (output_file.is_open()) {
      ...
      output_file << "     Execution time: " << execution.count() << " [s] for "
		  << std::endl;
      if (cfg.flow_basic) {
    ...
    std::cerr << color::RED
	      << "\n###########################################################"
	      << color::BOLD
	      << "\nSMASH ROOT analysis code FAILED with the following error:\n"
